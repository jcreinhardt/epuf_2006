...
#1967 amendments
# Based on 1965, but changed as noted in pdf page 14 of 1967 pdf.
def i1967(income_stream:list, index_year:int, retirement_year:int):
...
def a1967(adjusted_income_stream:list, original_income_stream:list, index_year:int, birth_year:int, retirement_year:int, reference_year:int, woman:bool, death_year = 0):
...
def q1967(adjusted_income_stream:list, original_income_stream:list, index_year:int, birth_year:int,  retirement_year:int, woman:bool): #this might not be completely correct/ might be off by half a year
    ...
    #print(adjusted_income_stream, birth_year, retirement_year)
    ...
    if coverage_quarters>40:
        ...
        #print(((4/4)*(end_year)-reference_year))
        return True
    else:
        return False


def qcurrent1967(income_stream:list, index_year:int, birth_year:int, retirement_year:int, reference_year:int, death_year:int, woman:bool): 
...
#see pdf page 4 of 1967 version
def bb1967(adjusted_income_stream:list, original_income_stream:list, avg_monthly_wage:float, index_year:int, birth_year:int, retirement_year:int, reference_year:int,  woman:bool):
    ...
    if (birth_year+65<1950): #this checks if they are old enough to have a pib; someone who did have a pib would receive a new updated pia based on these charts below, if they do they go through the formulas differently. This is what the tables primarily deal with.
        ...
        pia_1958=b1958(i1958(original_income_stream, index_year, retirement_year), original_income_stream, index_year, birth_year, retirement_year, reference_year,woman)
        
    pib_list = [
        [0, 15.60], [15.61, 16.20], [16.21, 16.84], [16.85, 17.60],
        [17.61, 18.40], [18.41, 19.24], [19.25, 20.00], [20.01, 20.64],
        [20.65, 21.28], [21.29, 21.88], [21.89, 22.28], [22.29, 22.68],
        [22.69, 23.08], [23.09, 23.44], [23.45, 23.76], [23.77, 24.20],
        [24.21, 24.60], [24.61, 25.00], [25.01, 25.48], [25.49, 25.92],
        [25.93, 26.40], [26.41, 26.94], [26.95, 27.46], [27.47, 28.00],
        [28.01, 28.68], [28.69, 29.25], [29.26, 29.68], [29.69, 30.36],
        [30.37, 30.92], [30.93, 31.36], [31.37, 32.00], [32.01, 32.60],
        [32.61, 33.20], [33.21, 33.88], [33.89, 34.50], [34.51, 35.00],
        [35.01, 35.80], [35.81, 36.40], [36.41, 37.08], [37.09, 37.60],
        [37.61, 38.20], [38.21, 39.12], [39.13, 39.68], [39.69, 40.33],
        [40.34, 41.12], [41.13, 41.76], [41.77, 42.44], [42.45, 43.20],
        [43.21, 43.76], [43.77, 44.44], [44.45, 44.88], [44.89, 45.60]
    ]

    pia_1965_list = [
        [48.00, 49.99], [50.00, 51.99], [52.00, 53.99], [54.00, 55.99], [56.00, 57.99],
        [58.00, 59.99], [60.00, 62.09], [62.10, 64.19], [64.20, 66.39], [66.40, 68.49],
        [68.50, 70.69], [70.70, 72.79], [72.80, 74.89], [74.90, 77.09], [77.10, 79.19],
        [79.20, 81.39], [81.40, 83.49], [83.50, 85.59], [85.60, 87.79], [87.80, 89.89],
        [89.90, 92.09], [92.10, 94.19], [94.20, 96.29], [96.30, 98.49], [98.50, 100.59],
        [100.60, 102.79], [102.80, 104.89], [104.90, 106.99], [107.00, 109.19], [109.20, 111.29],
        [111.30, 113.49], [113.50, 115.59], [115.60, 117.69], [117.70, 119.89], [119.90, 121.99],
        [122.00, 124.19], [124.20, 126.29], [126.30, 128.39], [128.40, 130.59], [130.60, 132.69],
        [132.70, 134.89], [134.90, 136.99], [137.00, 138.99], [139.00, 140.99], [141.00, 142.99],
        [143.00, 144.99], [145.00, 146.99], [147.00, 148.99], [149.00, 150.99], [151.00, 152.99],
        [153.00, 154.99], [155.00, 156.99], [157.00, 158.99], [159.00, 160.99], [161.00, 162.99],
        [163.00, 164.99], [165.00, 167.00]  # The last range is up to 167.00 as there's no next value
    ]

                
    avg_monthly_wage_list = [
        [0, 75], [75, 77], [77, 79], [79, 81], [81, 82], [82, 84], 
        [84, 86], [86, 88], [88, 90], [90, 91], [91, 93], [93, 95], [95, 97], 
        [97, 98], [98, 100], [100, 102], [102, 103], [103, 105], [105, 107], 
        [107, 108], [108, 110], [110, 114], [114, 119], [119, 123], [123, 128], 
        ...
        [240, 245], [245, 250], [250, 254], [254, 259], [259, 264], [264, 268], 
        [268, 273], [273, 278], [278, 282], [282, 287], [287, 292], [292, 296], 
        [296, 301], [301, 306], [306, 310], [310, 315], [315, 320], [320, 324], 
        [324, 329], [329, 334], [334, 338], [338, 343], [343, 348], [348, 352], 
        [352, 357], [357, 362], [362, 366], [366, 371], [371, 376], [376, 380], 
        [380, 385], [385, 390], [390, 394], [394, 399], [399, 404], [404, 408], 
        [408, 413], [413, 418], [418, 422], [422, 427], [427, 432], [432, 437], 
        [437, 441], [441, 446], [446, 451], [451, 455], [455, 460], [460, 465], 
        [465, 469], [469, 474], [474, 479], [479, 483], [483, 488], [488, 493], 
        [493, 497], [497, 502], [502, 507], [507, 511], [511, 516], [516, 521], 
        [521, 525], [525, 530], [530, 535], [535, 539], [539, 544], [544, 549], 
        [549, 554], [554, 557], [557, 561], [561, 564], [564, 568], [568, 571], 
        [571, 575], [575, 578], [578, 582], [582, 585], [585, 589], [589, 592]
    ]


    pia_list = [
    55, 55.40, 56.50, 57.7, 58.8, 59.9, 61.1, 62.2, 63.3, 64.5, 65.6, 66.7, 67.8, 69, 70.2, 
    71.5, 72.6, 73.8, 75.10, 76.3, 77.5, 78.7, 79.9, 81.1, 82.3, 83.6, 84.7, 85.9, 87.2, 88.4, 89.5, 
    90.8, 92, 93.2, 94.4, 95.6, 96.8, 98, 99.3, 100.5, 101.6, 102.9, 104.1, 105.2, 106.5, 107.7, 108.9, 
    110.10, 111.4, 112.6, 113.7, 115, 116.2, 117.3, 118.6, 119.8, 121, 122.2, 123.4, 124.7, 125.8, 127.1, 
    128.3, 129.4, 130.7, 131.9, 133, 134.3, 135.5, 136.8, 137.9, 139.1, 140.4, 141.5, 142.8, 144, 145.1, 
    146.4, 147.6, 148.9, 150, 151.2, 152.5, 153.6, 154.9, 156, 157.1, 158.2, 159.4, 160.5, 161.6, 162.8, 
    163.9, 165, 166.2, 167.3, 168.4, 169.5, 170.70, 171.8, 172.9, 174.10, 175.2, 176.3, 177.5, 178.6, 179.7, 
    180.8, 182, 183.1, 184.2, 185.4, 186.5, 187.6, 188.8, 189.9, 191, 192, 193, 194, 195, 196, 197, 198, 
    199, 200, 201
]
    ...
    if ((q1967(adjusted_income_stream, original_income_stream, index_year, birth_year,retirement_year, woman)==True)): #Check if the worker is fully-insured, as well as to place them in the proper formula
        for i in range(len(avg_monthly_wage_list)):
            if avg_monthly_wage>=avg_monthly_wage_list[i][0] and avg_monthly_wage<avg_monthly_wage_list[i][1]:
                pia_A=pia_list[i]
    if ((q1967(adjusted_income_stream, original_income_stream, index_year, birth_year,retirement_year, woman)==True) and (birth_year+65<1950)):
        for i in range(len(pib_list)):
            if pib>=pib_list[i][0] and pib<pib_list[i][1]:
                pia_B=pia_list[i]
    if ((q1967(adjusted_income_stream, original_income_stream, index_year, birth_year, retirement_year,woman)==True) and (birth_year+65<1967)):
        for i in range(len(pia_1965_list)):
            if pia_1965>=pia_1965_list[i][0] and pia_1965<pia_1965_list[i][1]:
                pia_C=pia_list[i]
...
def b1967(income_stream:list, original_income_stream:list, index_year:int, birth_year:int, retirement_year:int, reference_year:int, woman:bool):
    ...
    monthly_benefits=0
    adjusted_income_stream=i1967(income_stream, index_year, retirement_year)
    ...
    else:  avg_monthly_wage = a1967(adjusted_income_stream, original_income_stream, index_year, birth_year, reference_year, reference_year, woman)
    #print(avg_monthly_wage)
    nominal_total_contributions=t1967(adjusted_income_stream, index_year)
    monthly_benefits=bb1967(adjusted_income_stream, original_income_stream, avg_monthly_wage, index_year, birth_year, retirement_year, retirement_year, woman)
...
# pdf page 16 of 1967 pdf
def t1967(income_stream:list, index_year:int):
    
    employee_tax_rate = 0
    employer_tax_rate = 0
    nominal_contributions=[]

    adjusted_income_stream=i1967(income_stream, index_year, index_year + len(income_stream)) #to apply the taxable maximums to the benefit stream
...
def death1967(income_stream:list, index_year:int, birth_year:int, retirement_year:int, reference_year:int,death_year:int, woman:bool):
    '''
    ...
    '''
    if (q1967(income_stream, index_year, birth_year, retirement_year,woman)): 
        monthlyBenefits = b1967(income_stream, index_year, birth_year, retirement_year, woman)
        return max(3 * monthlyBenefits, 255)
    else:
        return 0
    

def spouse1967(income_stream:list, index_year:int, birth_year:int, retirement_year:int, reference_year:int, woman:bool, spouse_income_stream:list, spouse_index_year:int, spouse_birth_year:int, spouse_retirement_year:int, spouse_reference_year:int, spouse_woman:bool):
    """This function outputs the nominal monthly benefit (int) an individual would have received under the 1950 legislation. 
        The function inputs are (income_stream:list, index_year:int, birth_year:int).
        income_stream -- a list of nominal incomes a person received in each year.
        index_year -- the year in which an individual begins their income_stream.
    ...
    spousal_benefit = 0
    if q1967(spouse_income_stream, spouse_index_year, spouse_birth_year, spouse_retirement_year, spouse_woman):
        spouse_benefit = b1967(spouse_income_stream, spouse_index_year, spouse_birth_year, spouse_retirement_year, spouse_reference_year,spouse_woman)
    ...
    primary_PIA = bb1967(income_stream, primary_avg_monthly_wage, index_year, retirement_year, birth_year,reference_year, woman)
    ...
    if retirement_year > 1967:
        spouse_benefit_guarantee = min(105,0.5*primary_PIA) *deduction
    else:
...
def widow1967(income_stream:list, index_year:int, birth_year:int, retirement_year:int, reference_year:int, death_year:int, woman:bool, widow_income_stream:list, widow_index_year:int, widow_birth_year:int, widow_retirement_year:int, widow_reference_year:int, widow_woman:bool):
    """This function outputs the nominal monthly benefit (int) an individual would have received under the 1950 legislation. 
        The function inputs are (income_stream:list, index_year:int, birth_year:int).
        income_stream -- a list of nominal incomes a person received in each year.
        index_year -- the year in which an individual begins their income_stream.
    ...
    """ 
    if ((retirement_year >= widow_birth_year +62) or (widow_woman == True and retirement_year >= widow_birth_year +60)) and q1967(income_stream,index_year,birth_year, retirement_year,woman):
        if q1967(widow_income_stream,widow_index_year, widow_birth_year, widow_retirement_year, widow_woman):
            widowMonthlyBenefit = b1967(widow_income_stream, widow_index_year, widow_birth_year,widow_retirement_year, widow_reference_year, widow_woman)
        else: widowMonthlyBenefit = 0
        primary_adjusted_income_stream=i1967(income_stream, index_year, retirement_year)
        primary_avg_monthly_wage = a1967(primary_adjusted_income_stream, index_year, birth_year, retirement_year,reference_year, woman, death_year)
    
        primaryPIA = bb1967(income_stream,primary_avg_monthly_wage, index_year, birth_year, retirement_year, reference_year, woman)
...
def MFB1967(income_stream:list, index_year:int, birth_year:int, retirement_year:int, reference_year:int,death_year:int, woman:bool):
    """
    ...
    avg_monthly_wage_list = [
        [0, 74], [74, 76], [76, 78], [78, 80], [80, 81], [81, 83], [83, 85], 
        [85, 87], [87, 89], [89, 90], [90, 92], [92, 94], [94, 96], [96, 97], 
        [97, 99], [99, 101], [101, 102], [102, 104], [104, 106], [106, 107], 
        [107, 109], [109, 113], [113, 118], [118, 122], [122, 127], [127, 132], 
        [132, 136], [136, 141], [141, 146], [146, 150], [150, 155], [155, 160], 
        [160, 164], [164, 169], [169, 174], [174, 178], [178, 183], [183, 188], 
        [188, 193], [193, 197], [197, 202], [202, 207], [207, 211], [211, 216], 
        [216, 221], [221, 225], [225, 230], [230, 235], [235, 239], [239, 244], 
        [244, 249], [249, 253], [253, 258], [258, 263], [263, 267], [267, 272], 
        [272, 277], [277, 281], [281, 286], [286, 291], [291, 295], [295, 300], 
        [300, 305], [305, 309], [309, 314], [314, 319], [319, 323], [323, 328], 
        [328, 333], [333, 337], [337, 342], [342, 347], [347, 351], [351, 356], 
        [356, 361], [361, 365], [365, 370], [370, 375], [375, 379], [379, 384], 
        [384, 389], [389, 393], [393, 398], [398, 403], [403, 407], [407, 412], 
        [412, 417], [417, 421], [421, 426], [426, 431], [431, 436], [436, 440], 
        [440, 445], [445, 450], [450, 454], [454, 459], [459, 464], [464, 468], 
        [468, 473], [473, 478], [478, 482], [482, 487], [487, 492], [492, 496], 
        [496, 501], [501, 506], [506, 510], [510, 515], [515, 520], [520, 524], 
        [524, 529], [529, 534], [534, 538], [538, 543], [543, 548], [548, 553], 
        [553, 556], [556, 560], [560, 563], [563, 567], [567, 570], [570, 574], 
        [574, 577], [577, 581], [581, 584], [584, 588], [588, 591], [591, 595], 
        [595, 598], [598, 602], [602, 605], [605, 609], [609, 612], [612, 616], 
        [616, 620], [620, 623], [623, 627], [627, 630], [630, 634], [634, 637], 
        [637, 641], [641, 644], [644, 648], [648, 650]
    ]

    # Column V: Maximum Family Benefits
    maximum_family_benefits = [
        82.50, 83.10, 84.80, 86.60, 88.20, 89.90, 91.70, 93.30, 95.00, 96.80, 
        98.40, 100.10, 101.70, 103.50, 105.30, 107.30, 108.90, 110.70, 112.70, 
        114.50, 116.30, 118.10, 119.90, 121.70, 123.50, 125.40, 127.10, 128.90, 
        130.80, 132.60, 134.30, 136.20, 138.00, 139.80, 141.60, 143.40, 146.40, 
        150.40, 154.40, 157.60, 161.60, 165.60, 168.80, 172.80, 176.80, 180.00, 
        184.00, 188.00, 191.20, 195.20, 199.20, 202.40, 206.40, 210.40, 213.60, 
        217.60, 221.60, 224.80, 228.80, 232.80, 236.00, 240.00, 244.00, 247.20, 
        251.20, 255.20, 258.40, 262.40, 266.40, 269.60, 273.60, 277.60, 280.80, 
        284.80, 288.80, 292.00, 296.00, 300.00, 303.20, 307.20, 311.20, 314.40, 
        318.40, 322.40, 325.60, 329.60, 333.60, 336.80, 340.80, 344.80, 348.80, 
        350.40, 352.40, 354.40, 356.00, 358.00, 360.00, 361.60, 363.60, 365.60, 
        367.20, 369.20, 371.20, 372.80, 374.80, 376.80, 378.40, 380.40, 382.40, 
        384.00, 386.00, 388.00, 389.60, 391.60, 393.60, 395.60, 396.80, 398.40, 
        399.60, 401.20, 402.40, 404.00, 405.20, 406.80, 408.00, 409.60, 410.80, 
        412.40, 413.60, 415.20, 416.40, 418.00, 419.20, 420.80, 422.40, 423.60, 
        425.20, 426.40, 428.00, 429.20, 430.80, 432.00, 433.60, 434.40
    ]
...
def children1967(income_stream:list, index_year:int, birth_year:int, retirement_year:int, reference_year:int,death_year:int, woman:bool, child_birth_year:int):
    """
    ...
    if reference_year < death_year:
        ...
        primary_avg_monthly_wage = a1967(primary_adjusted_income_stream, index_year, birth_year, retirement_year,reference_year, woman, death_year)    
    primary_PIA = bb1967(income_stream, primary_avg_monthly_wage, index_year, birth_year, retirement_year,reference_year, woman)
