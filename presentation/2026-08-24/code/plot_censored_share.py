...
FROM THE PROJECT ROOT (the parameter CSV path is root-relative).
  ...
  python presentation/2026-08-24/code/plot_censored_share.py [csv]
    -> presentation/2026-08-24/figures/censored_share_cohort_age.pdf (+ .png)
"""
import sys
...
OUTDIR = Path("presentation/2026-08-24/figures")
